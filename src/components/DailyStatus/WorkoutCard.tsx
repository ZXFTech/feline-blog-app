          ...
          >
            <div>
              <div className="flex gap-1 items-center mb-2">
                ...
                <span className="text-sky-500 whitespace-nowrap">{s.duration} min</span>
              </div>

              <div className="flex gap-1 items-center">
                <Flame size={16} className="text-orange-700" />
                <span className="text-orange-700 whitespace-nowrap">{s.calories} kcal</span>
              </div>
            </div>
            <div>
              {s.duration ? (
                <div className="flex gap-1 items-center mb-2">
                  ...
                  <span className="text-pink-800 whitespace-nowrap">{s.duration} 次</span>
                </div>
              ) : null}
              {s.duration ? (
                <div className="flex gap-1 items-center">
                  <Dumbbell size={16} className="text-indigo-800" />
                  <span className="text-indigo-800 whitespace-nowrap">{s.duration} kg</span>
                </div>
              ) : null}
            </div>
          </NeuDiv>
