...
import PomodoroCalendar from "./index";

describe("PomodoroCalendar", () => {
  ...
  it("marks today with the warning background when another date is selected", () => {
    ...
    expect(screen.getByRole("button", { name: "2026-08-30" })).toHaveClass("bg-status-warning");
    expect(screen.getByRole("button", { name: "2026-08-15" })).not.toHaveClass("bg-status-warning");
  });
