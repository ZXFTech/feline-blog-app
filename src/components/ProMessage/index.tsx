...
const Toast = (props: ToastProps) => {
  ...
  const remainingTime = useRef(toast.duration || durationFromToaster || TOAST_LIFETIME);
  ...
  const icon = toast.icon || icons?.[toastType as keyof ToastIcons] || getAsset(toastType);
