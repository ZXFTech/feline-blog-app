...
export function ChecklistDetailDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[calc(100svh-2rem)] max-w-5xl flex-col overflow-hidden">
        ...
        <DialogDescription className="mt-2 flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <CountdownBadge expiresAt={checklist.expiresAt} textClass="text-sm" iconClass="size-3" />
        </DialogDescription>
