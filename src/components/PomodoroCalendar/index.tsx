...
export default function PomodoroCalendar({
  ...
  return (
    <section
      className="w-full min-w-0 space-y-4 rounded-lg border border-border p-2 text-foreground"
      aria-label="番茄钟日期"
    >
              ...
              <div role="gridcell" key={cell.dateKey} aria-selected={isSelected}>
                <button
                  ...
                  className={cn(
                    ...
                    isToday && !isSelected && "bg-status-warning hover:bg-status-warning",
                ...
                >
                  ...
                  <span
                    ...
                    className={cn(
                      ...
                      record && (record.color || "bg-status-success")
                    )}
                  />
                </button>
              </div>
